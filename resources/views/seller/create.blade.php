        ...
        <div class="col-md-6">
               <div class="card mt-5 shadow">
                <div class="card-body m-3">
                    ...
                    <div class="">
                        <form action={{ route('seller.store') }} id='createForm' onsubmit="disableSubmitButton()"  method="post">
                            @csrf
                        <div class="mb-3 mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="township" class="form-control @error('township') is-invalid @enderror " value="{{ old('township') }}">
                            @error('township')
                                <div class="text-danger">*{{ $message }}</div>
                            @enderror
                        </div>
